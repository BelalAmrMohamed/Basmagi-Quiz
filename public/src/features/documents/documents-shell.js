...
const sidebarMarkup = `
  ...
  <aside class="sidebar" id="sidebar" role="dialog" aria-modal="true" aria-label="القائمة الجانبية" aria-hidden="true" tabindex="-1">
    ...
    <div class="sidebar-header sidebar-expanded-only">
      <div class="sidebar-brand-link" aria-label="منصة امتحانات بصمجي">
        <div class="sidebar-logo" title="منصة امتحانات بصمجي">
          <img src="./favicon.png" alt="" class="sidebar-favicon-img"><span class="sidebar-brand-text">امتحانات بصمجي</span>
        </div>
      </div>
    ...
    <nav role="navigation" aria-label="روابط التنقل">
      ...
      <a href="create-quiz" title="إنشاء امتحانات" class="menu-item" data-tooltip="إنشاء امتحانات"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><!-- Lightbulb outline --><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.9 1.2 1.5 1.5 2.5" /><path d="M9 18h6" /><path d="M10 22h4" /><!-- Question Mark inside --><path d="M10.5 6.5a1.5 1.5 0 0 1 3 0c0 1-1.5 1.5-1.5 2.5" /><path d="M12 12h.01" /><!-- Subtle "Creator" spark/plus --><line x1="19" y1="18" x2="19" y2="22" /><line x1="17" y1="20" x2="21" y2="20" /></svg><span class="menu-label">إنشاء امتحانات</span></a>
      <a href="create-lesson" title="إنشاء دروس" class="menu-item" data-tooltip="إنشاء دروس"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20" /><path d="M9 10h6" /><path d="M12 7v6" /></svg><span class="menu-label">إنشاء دروس</span></a>
