    ...
    <div class="sidebar-header sidebar-expanded-only">
      <div class="sidebar-brand-link" aria-label="منصة امتحانات بصمجي">
        <div class="sidebar-logo" title="منصة امتحانات بصمجي">
          <svg xmlns="http://www.w3.org/2000/svg" width="180" height="40" viewBox="0 0 220 40" style="direction: ltr;"><text x="0" y="27" font-family="Tajawal, Arial, sans-serif" font-size="17" font-weight="bold" fill="currentColor" text-anchor="start" class="sidebar-brand-text">امتحانات بصمجي</text><image x="175" y="0" width="45" height="45" href="./favicon.png" /></svg>
        </div>
      </div>
