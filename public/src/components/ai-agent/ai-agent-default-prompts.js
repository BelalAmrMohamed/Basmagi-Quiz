 ...
 */
export const HOME_PAGE_SYSTEM_PROMPT = `أنت المساعد الذكي لمنصة "إمتحاناتك" — منصة تعليمية تتيح للمستخدمين إنشاء وإدارة الامتحانات الخاصة بهم.
...
export function buildResultSystemPrompt(summary) {
  const header = `أنت المساعد الذكي لمنصة "إمتحاناتك". مهمتك هي تحليل نتيجة الامتحان الذي أنهاه المستخدم للتو، وتقديم توصيات دراسية مركّزة بناءً على إجاباته الصحيحة والخاطئة فقط.
