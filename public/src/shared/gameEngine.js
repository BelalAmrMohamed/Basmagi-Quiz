...
export const BADGES = [
  // Starter Badges
  {
    ...
    desc: "خلصت أول امتحان! ودي دايماً بتكون أصعب خطوة",
  },
  {
    id: "beginner",
    icon: "🎯",
    title: "مبتدئ شاطر",
    desc: "3 امتحانات في جيبك، إنت ماشي صح يا بطل",
  },
  ...
  // Completion Badges
  {
    ...
    icon: "🌟",
    title: "سريع البديهة",
    desc: "5 امتحانات وإنت لسه فاتح، ما شاء الله مخك شغال ألماظ",
  },
  {
    id: "dedicated",
    icon: "📖",
    title: "مواظب",
    desc: "10 امتحانات، يعني إنت بقيت من الدايمين هنا",
  },
  {
    id: "scholar",
    icon: "📚",
    title: "الطالب النجيب",
    desc: "25 امتحان؟ يا نهار أبيض، إنت فاكرها كلية",
  },
  {
    id: "academic",
    icon: "🎓",
    title: "الأكاديمي",
    desc: "50 امتحان، لو فيه دكتوراه هنا كنت خدتها",
  },
  {
    id: "professor",
    icon: "👨‍🏫",
    title: "الدكتور بتاعنا",
    desc: "100 امتحان! إنت مش بتذاكر، إنت بقيت المنهج",
  },
  ...
  // Performance Badges
  {
    ...
    icon: "🏆",
    title: "مُقفل العداد",
    desc: "100% في امتحان، إنت عملت اللي عليك وزيادة",
  },
  {
    id: "sharpshooter",
    icon: "🎯",
    title: "قناص الدرجات",
    desc: "90%+ في 5 امتحانات، تصويبك ما بيخيبش",
  },
  {
    id: "ace",
    icon: "⭐",
    title: "نجم الدفعة",
    desc: "95%+ في 10 امتحانات، إنت اللي بيتاخد منه الدرس",
  },
  {
    id: "on-fire",
    icon: "🔥",
  ...
  // Speed Badges
  {
    ...
    icon: "⚡",
    title: "البرق الخاطف",
    desc: "خلصت الامتحان في أقل من دقيقتين، بسم الله ما شاء الله طيارة",
  },
  {
    id: "lightning-round",
    icon: "⚡",
  ...
  },
  {
    ...
    icon: "💨",
    title: "صاروخ",
    desc: "5 امتحانات كل واحدة تحت دقيقتين، إيه السرعة دي كلها رايح فين",
  },
  ...
  },
  {
    ...
    icon: "🎭",
    title: "بتاع كله",
    desc: "خلصت امتحانات في 10 تصنيفات، إنت موسوعة ماشية",
  },
  ...
  },
  {
    ...
    icon: "🌅",
    title: "بركة البكور",
    desc: "خلصت امتحان قبل الساعة 8 الصبح، اللهم بارك في النشاط",
  },
  {
    id: "night-owl",
    icon: "🦉",
    title: "سهران للصبح",
    desc: "خلصت امتحان بعد الساعة 10 بليل، إنت وشغلك سهرانين مع بعض",
  },
  {
  ...
  },
  {
    ...
    desc: "20 امتحان تدريب، إنت بتتمرن زي اللي رايح الأولمبياد",
  },
];
// Level System
const LEVEL_CONFIG = {
