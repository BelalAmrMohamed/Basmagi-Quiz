...
const welcomeMessages = [
  (name) => `🏆 نورت مكانك ${name}.. يلا ورّينا إتقانك!`,
  (name) => `🚀 طالت الغيبة ${name}.. بس رجعتك دايماً هيبة!`,
  (name) => `🎮 التحدي بينادي ${name}.. والتقفيل النهاردة عادي!`,
  (name) => `🔔 امتحان جديد بيناديك ${name}.. والتحدي واقف مستنيك!`,
  (name) => `🧠 سؤال جديد وجواب سديد.. نورت من تاني ${name} يا شديد!`,
  (name) => `⚡ الـ XP بيزيد ${name}.. والتقفيل عليك مش بعيد!`,
